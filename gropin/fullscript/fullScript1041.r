...
#############################
############################# 
# start of Model script Gropin ID 1041 
#############################
...
#############################
############################# 
# start of Visualisation script Gropin ID 1041 
#############################
...
Zygosaccharomyces bailii in/on Dairy products, Sugar solutions, beverages
(gropin ID:1041)',outer=T,  cex=1.5, line=-8.5, side=3)
#############################
