...
pH <- seq(4.39439,9.39060939060939,length.out=21)
aw <- seq(0.935935,0.998001998001998,length.out=21)
#############################
...
#############################
############################# 
# start of Visualisation script Gropin ID 469 
#############################
...
Listeria monocytogenes in/on Food products
(gropin ID:469)',outer=T,  cex=1.5, line=-8.5, side=3)
#############################
