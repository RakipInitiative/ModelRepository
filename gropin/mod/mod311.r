...
response_surface <- function(T,pH,aw,Phe,NaNO2,CO2) {
   0.742*(((T-45.5)*((T+1.72)^2))/((37+1.72)*((37+1.72)*(T-37)-(37-45.5)*(37-1.72-2*T))))*(((pH-9.61)*(pH-4.71))/(((7.1-4.71)*(pH-7.1))-((7.1-9.61)*(4.71-pH))))*((aw-0.913)/(0.997-0.913))*(1-(NaNO2/25))*(1-(Phe/31.9))*(1-(CO2/3.04))
} 
