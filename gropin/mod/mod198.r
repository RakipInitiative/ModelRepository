...
response_surface <- function(T,pH,aw,NaNO2) {
   ln(2)/exp((-732.446-(0.175*T)+(1565.5724*aw)-(9.5432*pH)+(0.0292*NaNO2)+(0.0718*T*aw)-(0.0143*T*pH)+(0.000005*T*NaNO2)+(6.1934*aw*pH)-(0.00716*aw*NaNO2)-(0.00283*pH*NaNO2)+(0.00273*(T^2))-(819.613*(aw^2))+(0.2633*(pH^2))-(0.000001*(NaNO2^2))))
} 
