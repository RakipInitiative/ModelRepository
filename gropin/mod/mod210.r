...
response_surface <- function(T,pH,aw,NaNO2) {
   ln(2)/exp(227.007-0.2721*T-377.389*aw-8.6224*pH+0.0303*NaNO2+0.00787*T*pH+3.2923*aw*pH-0.0117*aw*NaNO2-0.00249*pH*NaNO2+0.00273*(T^2)+171.9852*(aw^2)+0.3853*(pH^2))
} 
