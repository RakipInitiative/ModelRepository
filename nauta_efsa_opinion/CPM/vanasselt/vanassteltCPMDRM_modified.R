...
myCPMname <- c("CPM vanAsselt")
modConsumerPhaseVanAsselt <- function(niter, 
                                      Pprev, 
                                      muCret, sigmaCret, piCret,
                                      CretLogMin, CretLogMax, CretLogStep, 
                                      meanPortion, stdPortion, upperPortion, 
                                      transferRateWashedHandsMean, transferRateWashedHandsStd, 
                                      transferRateUnwashedHandsMean, transferRateUnwashedHandsStd, 
                                      transferRateWashedBoardMean, transferRateWashedBoardStd, 
                                      transferRateUnwashedBoardMean, transferRateUnwashedBoardStd, 
                                      probUnwashedHands, probWashedHands, 
                                      probUnwashedBoard, probWashedHandsBoard){
...
runConsumerPhaseVanAsselt <- modConsumerPhaseVanAsselt(niter, 
                                                       Pprev, 
                                                       muCret, sigmaCret, piCret,
                                                       CretLogMin, CretLogMax, CretLogStep, 
                                                       meanPortion, stdPortion, upperPortion, 
