...
#################################
# set.seed(1234)
#modConsumerPhaseFAOWHO <- function(niter, Pprev, CretLogMin, CretLogMax, CretLogStep, meanPortion, stdPortion, upperPortion, logPtr){
...
#runConsumerPhaseFAOWHO <- modConsumerPhaseFAOWHO(niter, Pprev, CretLogMin, CretLogMax, CretLogStep, meanPortion, stdPortion, upperPortion, logPtr)
