...
#################################
# set.seed(1234)
modConsumerPhaseChristensen <- function(niter, Pprev, CretLogMin, CretLogMax, CretLogStep, meanPortion, stdPortion, upperPortion,
...
runConsumerPhaseChristensen <- modConsumerPhaseChristensen(niter, Pprev, CretLogMin, CretLogMax, CretLogStep, meanPortion, stdPortion, upperPortion,
                                                           mintCE, modetCE, maxtCE, mintEC, modetEC, maxtEC, fCC, 
                                                           mintES, modetES, maxtES, fCS)
